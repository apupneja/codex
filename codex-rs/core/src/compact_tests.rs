...
fn collect_user_messages_filters_legacy_warnings() {
    let items = vec![
        ...
        user_message(
            "Warning: Your provider flagged this account for potentially high-risk cyber activity and routed the request to a fallback model. Contact your provider administrator if you need authorized access for security work.",
        ),
