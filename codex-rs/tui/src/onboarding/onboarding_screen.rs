...
//!
//! The onboarding flow is a small state machine over its welcome and directory
//! trust steps. This module decides which visible step receives key and paste
//! events and persists the resulting trust decision.
...
impl WidgetRef for &OnboardingScreen {
    fn render_ref(&self, area: Rect, buf: &mut Buffer) {
        for step in self.current_steps() {
            match step {
                Step::Welcome(widget) => widget.set_animations_suppressed(false),
