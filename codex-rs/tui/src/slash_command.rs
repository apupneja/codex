...
impl SlashCommand {
    ...
    pub fn description(self) -> &'static str {
        match self {
            ...
            SlashCommand::Init => "create an AGENTS.md file with instructions for Redapto",
            ...
            SlashCommand::Quit | SlashCommand::Exit => "exit Redapto",
            SlashCommand::Copy => "copy last response as markdown",
            SlashCommand::Export => "export the conversation as markdown",
            SlashCommand::Raw => "toggle raw scrollback mode for copy-friendly terminal selection",
            SlashCommand::Diff => "show git diff (including untracked files)",
            SlashCommand::Mention => "mention a file",
            SlashCommand::Skills => "use skills to improve how Redapto performs specific tasks",
            ...
            SlashCommand::Personality => "choose a communication style for Redapto",
            ...
            SlashCommand::Permissions => "choose what Redapto is allowed to do",
