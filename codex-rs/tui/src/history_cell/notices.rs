...
pub(crate) fn new_safety_access_block_event() -> SafetyAccessBlockCell {
    SafetyAccessBlockCell {
        body: "This provider applies extra caution to requests involving biological research and applications that could pose safety risks. Contact your provider administrator if you believe access should be allowed.",
    }
}

pub(crate) fn new_cyber_policy_error_event() -> SafetyAccessBlockCell {
    SafetyAccessBlockCell {
        body: "This provider applies extra caution to cybersecurity requests. Contact your provider administrator if you believe access should be allowed.",
    }
}
...
impl HistoryCell for SafetyAccessBlockCell {
    ...
    fn raw_lines(&self) -> Vec<Line<'static>> {
        vec![Line::from(SAFETY_ACCESS_BLOCK_TITLE), Line::from(self.body)]
    }
