...
#[derive(Debug, Parser)]
#[command(bin_name = "redapto plugin marketplace")]
...
enum MarketplaceSubcommand {
    ...
    /// List plugin marketplaces Redapto is currently considering and their roots.
...
#[derive(Debug, Parser)]
#[command(
    bin_name = "redapto plugin marketplace add",
    after_help = "Examples:\n  redapto plugin marketplace add ./path/to/marketplace\n  redapto plugin marketplace add owner/repo --ref main\n  redapto plugin marketplace add https://github.com/owner/repo --sparse plugins/foo"
)]
...
#[derive(Debug, Parser)]
#[command(bin_name = "redapto plugin marketplace list")]
...
#[derive(Debug, Parser)]
#[command(
    bin_name = "redapto plugin marketplace upgrade",
    after_help = "Examples:\n  redapto plugin marketplace upgrade\n  redapto plugin marketplace upgrade debug"
)]
...
#[derive(Debug, Parser)]
#[command(
    bin_name = "redapto plugin marketplace remove",
    after_help = "Example:\n  redapto plugin marketplace remove debug"
)]
