...
const SESSION_NAME: &str = "Redapto Windows Sandbox WFP";
const PROVIDER_NAME: &str = "Redapto Windows Sandbox WFP";
const PROVIDER_DESCRIPTION: &str = "Persistent WFP provider for Redapto Windows sandbox filters";
const SUBLAYER_NAME: &str = "Redapto Windows Sandbox WFP";
const SUBLAYER_DESCRIPTION: &str = "Persistent WFP sublayer for Redapto Windows sandbox filters";

// WFP identifies persistent providers, sublayers, and filters by stable GUIDs.
// These values are Redapto-owned identities; do not regenerate them unless we
...
/// Installs the persistent Redapto WFP filters for `account`.
///
...
/// Ensures the persistent Redapto WFP provider exists.
...
/// Ensures the persistent Redapto sublayer exists under the Redapto provider.
